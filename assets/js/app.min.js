...
window.addEventListener('popstate',()=>{location.reload();});function openScreen1(){(async()=>{const response=await fetch('http://192.168.2.14:9981/Active1',{method:'POST',mode:'no-cors',headers:{'Content-Type':'application/json;charset=utf-8'}});})()}
function openScreen2(){(async()=>{const response=await fetch('http://192.168.2.14:9981/Active2',{method:'POST',mode:'no-cors',headers:{'Content-Type':'application/json;charset=utf-8'}});})()}
function openScreen(){openScreen1()
openScreen2()}
window.addEventListener('DOMContentLoaded',function(){const wrapper=document.querySelector('.wrapper')
const links=document.querySelectorAll('a')
for(let i=0;i<links.length;i++){const link=links[i]
link.addEventListener('click',function(e){e.preventDefault()
history.pushState({urlPath:link.href},"",link.href);if(link.href.includes('nko')){openScreen1()
wrapper.innerHTML=`
    ...
    <div class="single__container container">
        ...
        <div class="single__image single__image_b">
            <img src="assets/images/handshake.png" alt="">
                ...
                `}
if(link.href.includes('partners')){openScreen2()
wrapper.innerHTML=`<div class="single block">
                ...
                `}
if(link.href.includes('kind-donate')){wrapper.innerHTML=`<div class="kind kind_kind block">
        ...
        <div class="kind__container container">
            ...
            <div class="kind__body">
                ...
                `}
if(link.href.includes('kind-partners')){wrapper.innerHTML=`
